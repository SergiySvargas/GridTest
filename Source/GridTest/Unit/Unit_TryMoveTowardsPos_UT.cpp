...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FUnit_TryMoveTowardsPos_UT, "_Tests.Unit", EAutomationTestFlags::EditorContext | EAutomationTestFlags::SmokeFilter)
bool FUnit_TryMoveTowardsPos_UT::RunTest(const FString& Parameters)
{
	...
	moved = unit->TryMoveTowardsPos(targetPos);
	check(moved == true);
